...
MINIMUM OPINION COUNT (mandatory): Generate at least 5 non-duplicate review opinions for EACH applicable review area, not 5 opinions total. For fire-protection drawings, provide at least 5 items in each of these areas: (A) document completeness and legal applicability, (B) architectural/drawing coordination, (C) water-based suppression and hydraulic design, (D) alarm/evacuation/smoke-control/firefighting facilities, (E) electrical-mechanical interlock, and (F) constructability/maintenance. Each item must have a different topic, criterion, observation, status, evidence, legal basis, and recommendation. If the supplied drawing cannot verify five items in an area, generate five distinct NEEDS_CONFIRMATION requests identifying the exact missing drawing, calculation, schedule, or site information. Never pad the count with generic statements or repeated wording.
